...
#SBATCH --job-name=train-tiny-score
...
CKPT_OUT="${CKPT_OUT:-$REPO/src/mtf_aware_deblurring/assets/tiny_score_unet.pth}"
EPOCHS="${EPOCHS:-50}"
BATCH="${BATCH:-64}"
LR="${LR:-1e-4}"
BASE_CH="${BASE_CH:-64}"
...
python "$REPO/train_tiny_score_model.py" \
